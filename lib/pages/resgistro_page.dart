...
import 'package:form_validation_bloc/providers/usuario_provider.dart';
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          FlatButton(
              child: Text('¿Ya tienes una cuenta? Log in'),
              onPressed: () =>
        ...
        return Container(
          ...
          child: TextField(
            ...
            onChanged: (value) => bloc
                .changeEmail(value), //bloc.changeEmail <- Tambien puede ser asi
          ),
        );
      },
    );
